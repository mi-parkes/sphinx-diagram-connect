...
class DiagramConnect:
    ...
    def _init_needs(self, app):
        ...
        needs_list_obj = NeedsList(
            app.env.config, app.outdir, app.srcdir
        )
        needs_list_obj.load_json(os.path.join(app.builder.outdir, "needs.json"))
    ...
    def _resolve_ref(self, app, target, rtype):
        ...
        try:
            ...
            newnode = domain.resolve_xref(
                app.env, refdoc, app.builder, typ, rtarget, node, contnode
            )
            if newnode:
    ...
    def resolve_references(self, app, exception):
        """
